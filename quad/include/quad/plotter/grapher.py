...
x_points_1, y_points_1, z_points_1, x_time_1, y_time_1, z_time_1 = file_reader('uav1_pos.txt', 'pos')
x_points_2, y_points_2, z_points_2, x_time_2, y_time_2, z_time_2 = file_reader('uav2_pos.txt', 'pos')
...
ax.plot(x_points_1, y_points_1, z_points_1, label='UAV 1 Trajectory')
ax.plot(x_points_2, y_points_2, z_points_2, label='Survivor\'s Trajectory')
