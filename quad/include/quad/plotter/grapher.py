...
def file_reader(position_file_txt, plotting_parameter):
    ...
    end_second = 0
    start_tracker = 0
    start_second_decimal = 0
    end_second_decimal = 0
    file_elements = []
    x_points = []
    y_points = []
    z_points = []
...
plt.savefig('/home/sarthak/catkin_ws/src/assets/UAV1Coordinates.png')
plt.show()
...
plt.ylabel("X/Y/Z Position")
plt.legend(['X Position', 'Y Position', 'Z Position'])
plt.savefig('/home/sarthak/catkin_ws/src/assets/UAV2Coordinates.png')
plt.show()
...
plt.ylabel("X/Y/Z Position")
plt.legend(['X Position', 'Y Position', 'Z Position'])
plt.savefig('/home/sarthak/catkin_ws/src/assets/SurvivorCoordinates.png')
plt.show()
